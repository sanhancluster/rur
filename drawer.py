...
class ccm:
    ...
    hesperia=load_cmap(join(mypath, "colormaps/data/hesperia.csv"))
    laguna=load_cmap(join(mypath, "colormaps/data/laguna.csv"))
    lacerta=load_cmap(join(mypath, "colormaps/data/lacerta.csv"))
    mod_plasma=load_cmap(join(mypath, "colormaps/data/mod_plasma.csv"))
